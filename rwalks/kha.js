...
Main.__name__ = true;
Main.main = function() {
	kha_System.init({ title : "Project", width : 1024, height : 768, samplesPerPixel : 4},function() {
		new Project();
	});
};
Math.__name__ = true;
var PCG32 = function(st,seq) {
	var this1 = new haxe__$Int64__$_$_$Int64(1481765933,1284865837);
	this.FAC = this1;
	...
	var a;
	if(b == 0) {
		var this2 = new haxe__$Int64__$_$_$Int64(seq.high,seq.low);
		a = this2;
	} else if(b < 32) {
		var this3 = new haxe__$Int64__$_$_$Int64(seq.high << b | seq.low >>> 32 - b,seq.low << b);
		a = this3;
	} else {
		var this4 = new haxe__$Int64__$_$_$Int64(seq.low << b - 32,0);
		a = this4;
	}
	var this5 = new haxe__$Int64__$_$_$Int64(0,1);
	var b1 = this5;
	var this6 = new haxe__$Int64__$_$_$Int64(a.high | b1.high,a.low | b1.low);
	this.inc = this6;
	this.random();
	var a1 = this.state;
	var high = a1.high + st.high | 0;
	var low = a1.low + st.low | 0;
...
$hxClasses["PCG32"] = PCG32;
PCG32.__name__ = true;
PCG32.walk = function(st,seq,drift) {
	var rng = new PCG32(st,seq);
...
PCG32.test = function() {
	var this1 = new haxe__$Int64__$_$_$Int64(0,42);
	var this2 = new haxe__$Int64__$_$_$Int64(0,54);
	var rnd = new PCG32(this1,this2);
	var expect = "A15C02B7,7B47F409,BA1D3330,83D2F293,BFA4784B";
	var _g = [];
	var _g1 = 0;
	while(_g1 < 5) {
		var i = _g1++;
		_g.push(StringTools.hex(rnd.random(),8));
	}
	var vec = _g;
	var svec = vec.join(",");
	haxe_Log.trace(expect,{ fileName : "Project.hx", lineNumber : 61, className : "PCG32", methodName : "test", customParams : ["==",svec,expect == svec]});
	return expect == svec;
};
PCG32.prototype = {
	FAC: null
	...
	,inc: null
	,random: function() {
		var this1 = this.state;
		var this2 = new haxe__$Int64__$_$_$Int64(this1.high,this1.low);
		var oldstate = this2;
		var b = this.FAC;
		var mask = 65535;
		var al = oldstate.low & mask;
		var ah = oldstate.low >>> 16;
		var bl = b.low & mask;
		var bh = b.low >>> 16;
		...
		high = high + (haxe__$Int32_Int32_$Impl_$._mul(oldstate.low,b.high) + haxe__$Int32_Int32_$Impl_$._mul(oldstate.high,b.low) | 0) | 0;
		...
		var tmp;
		if(b2 == 0) {
			var this5 = new haxe__$Int64__$_$_$Int64(oldstate.high,oldstate.low);
			tmp = this5;
		} else if(b2 < 32) {
			var this6 = new haxe__$Int64__$_$_$Int64(oldstate.high >>> b2,oldstate.high << 32 - b2 | oldstate.low >>> b2);
			tmp = this6;
		} else {
			var this7 = new haxe__$Int64__$_$_$Int64(0,oldstate.high >>> b2 - 32);
			tmp = this7;
		}
		var this8 = new haxe__$Int64__$_$_$Int64(tmp.high ^ oldstate.high,tmp.low ^ oldstate.low);
		tmp = this8;
		var b3 = 27;
		b3 &= 63;
		if(b3 == 0) {
			var this9 = new haxe__$Int64__$_$_$Int64(tmp.high,tmp.low);
			tmp = this9;
		} else if(b3 < 32) {
			var this10 = new haxe__$Int64__$_$_$Int64(tmp.high >>> b3,tmp.high << 32 - b3 | tmp.low >>> b3);
			tmp = this10;
		} else {
			var this11 = new haxe__$Int64__$_$_$Int64(0,tmp.high >>> b3 - 32);
			tmp = this11;
		}
		var xorshifted = tmp.low;
		var b4 = 59;
		b4 &= 63;
		var tmp1;
		if(b4 == 0) {
			var this12 = new haxe__$Int64__$_$_$Int64(oldstate.high,oldstate.low);
			tmp1 = this12;
		} else if(b4 < 32) {
			var this13 = new haxe__$Int64__$_$_$Int64(oldstate.high >>> b4,oldstate.high << 32 - b4 | oldstate.low >>> b4);
			tmp1 = this13;
		} else {
			var this14 = new haxe__$Int64__$_$_$Int64(0,oldstate.high >>> b4 - 32);
			tmp1 = this14;
		}
		var rot = tmp1.low;
		var r = xorshifted >>> rot | xorshifted << (-rot & 31);
		return r;
	}
	,__class__: PCG32
};
var RandomWalk = function(rng,t0,drift,weight) {
	this.rng = rng;
	this.last = t0;
	this.drift = drift;
	this.weight = weight;
};
$hxClasses["RandomWalk"] = RandomWalk;
RandomWalk.__name__ = true;
RandomWalk.make = function(seed,t0,drift,weight) {
	var this1 = new haxe__$Int64__$_$_$Int64(0,42);
	var this2 = new haxe__$Int64__$_$_$Int64(seed >> 31,seed);
	var rng = new PCG32(this1,this2);
	var walk = new RandomWalk(rng,t0,drift,weight);
	return walk;
};
RandomWalk.prototype = {
	...
	,step: function() {
		...
		var r1 = (r & 8) == 0 ? 1 : -1;
		var v = this.drift + this.weight * this.last + r1;
		this.last = v;
		return v;
	}
	,__class__: RandomWalk
};
var RingBuffer = function(w,h,delta) {
	this.w = w;
	this.h = h;
	this.d = delta;
	this.cur = kha_Image.createRenderTarget(w,h);
	this.nxt = kha_Image.createRenderTarget(w,h);
	this.upd = kha_Image.createRenderTarget(this.d,h);
};
$hxClasses["RingBuffer"] = RingBuffer;
RingBuffer.__name__ = true;
RingBuffer.prototype = {
	...
	,h: null
	,d: null
	,_loop: function(bb,target) {
		var g = target.get_g2();
		g.begin();
		g.drawSubImage(bb,0,0,this.d,0,this.w - this.d,this.h);
		g.drawSubImage(bb,this.w - this.d,0,0,0,this.d,this.h);
		g.end();
	}
	,loop: function() {
		var c = this.cur;
		this._loop(this.cur,this.nxt);
		this.cur = this.nxt;
		this.nxt = c;
		return this.cur;
	}
	,_advance: function(bb,target,d) {
		var g = target.get_g2();
		g.begin();
		g.drawSubImage(bb,0,0,d,0,this.w - d,this.h);
	}
	,advance: function(delta,upd) {
		var d = delta > this.d ? this.d : delta;
		var c = this.cur;
		this._advance(this.cur,this.nxt,d);
		this.cur = this.nxt;
		this.nxt = c;
		var g = this.cur.get_g2();
		g.drawSubImage(upd,this.w - d,0,0,0,d,this.h);
		g.end();
		return this.cur;
	}
	,__class__: RingBuffer
};
var Walks = function(t0s,maxdelta) {
	var _g = [];
	var _g2 = 0;
	var _g1 = t0s.length;
	while(_g2 < _g1) {
		var i = _g2++;
		_g.push(RandomWalk.make(i,t0s[i],0,1));
	}
	this.walks = _g;
	var _g11 = [];
	var _g21 = 0;
...
Walks.prototype = {
	...
	,steps: function(n) {
		var _g1 = 0;
		var _g = this.walks.length;
		while(_g1 < _g) {
			var w = _g1++;
			var walk = this.walks[w];
			var _g3 = 0;
			var _g2 = n;
			while(_g3 < _g2) {
				var s = _g3++;
				this._steps[w][s][0] = walk.last;
				this._steps[w][s][1] = walk.step();
			}
		}
		return this._steps;
	}
...
var DrawWalks = function(maxdelta) {
	...
	this.walks = new Walks(_g,maxdelta);
	this.ring = new RingBuffer(1024,768,maxdelta);
};
$hxClasses["DrawWalks"] = DrawWalks;
DrawWalks.__name__ = true;
DrawWalks.prototype = {
	walks: null
	,ring: null
	,maxdelta: null
	...
	,render: function(delta) {
		var delta1 = delta > this.maxdelta ? this.maxdelta : delta;
		var g = this.ring.upd.get_g2();
		var ws = this.walks.steps(delta1);
		g.begin();
		var _g = 0;
		while(_g < ws.length) {
			var w = ws[_g];
			...
			while(_g2 < _g1) {
				...
				var y1 = w[p][0];
				var y2 = w[p][1];
				g.drawLine(p,y1,p + 1,y2);
			}
		}
		g.end();
		return this.ring.advance(delta1,this.ring.upd);
	}
	,__class__: DrawWalks
};
var Project = function() {
	...
	var _gthis = this;
	this.maxdelta = 70;
	this.dw = new DrawWalks(this.maxdelta);
	...
	kha_Assets.loadEverything(function() {
		...
		kha_Scheduler.addTimeTask($bind(_gthis,_gthis.update),0,0.0166666666666666664);
		if(kha_input_Keyboard.get() != null) {
			kha_input_Keyboard.get().notify($bind(_gthis,_gthis.keyDown),$bind(_gthis,_gthis.keyUp));
		}
		if(kha_input_Mouse.get() != null) {
			kha_input_Mouse.get().notify(null,null,$bind(_gthis,_gthis.mouseMove),null);
		}
	});
	this.data();
	this.i_cur = this.mkImage();
	this.i_next = kha_Image.createRenderTarget(1024,768);
};
...
Project.prototype = {
	...
	,i_next: null
	,mkImage: function() {
		var bb = kha_Image.createRenderTarget(1024,768);
		var g = bb.get_g2();
		g.begin();
		g.clear();
		g.set_color(-1);
		...
		while(_g < 1000) {
			...
			while(_g1 < 50) {
				var yoff = _g1++;
				var y = this.arr[x + this.offset] * this.scale + (10 + yoff) * 10;
				var yy = this.arr[x + this.offset + 1] * this.scale + (10 + yoff) * 10;
				g.drawLine(x,y,x + 1,yy);
			}
		}
		g.end();
		return bb;
	}
	,advance: function(bb,target) {
		var g = target.get_g2();
		var w = 1000;
		g.begin();
		g.drawSubImage(bb,0,0,1,0,w - 1,bb.get_height());
		g.drawSubImage(bb,w - 1,0,0,0,1,bb.get_height());
		g.end();
	}
	,my: null
	,mouseMove: function(x,y,xx,yy) {
		this.scale = y / 2;
		this.my = y;
	}
	,keyUp: function(v) {
	...
	,render: function(frame) {
		...
		if(delta < this.maxdelta) {
			bb = this.dw.render(delta);
		} else {
			bb = this.dw.ring.cur;
		}
		frame.get_g2().begin();
		kha_Scaler.scale(bb,frame,kha_System.get_screenRotation());
		frame.get_g2().end();
	}
	,__class__: Project
};
...
var kha__$Assets_FontList = function() {
	this.names = ["VeraMono"];
	this.VeraMonoDescription = { files : ["VeraMono.ttf"], type : "font", name : "VeraMono"};
	this.VeraMonoName = "VeraMono";
	this.VeraMono = null;
};
...
kha__$Assets_FontList.prototype = {
	VeraMono: null
	,VeraMonoName: null
	,VeraMonoDescription: null
	,VeraMonoLoad: function(done) {
		kha_Assets.loadFont("VeraMono",function(font) {
			done();
		});
	}
	,VeraMonoUnload: function() {
		this.VeraMono.unload();
		this.VeraMono = null;
	}
	,names: null
